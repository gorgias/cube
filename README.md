...
```bash
docker build -t us-east1-docker.pkg.dev/gorgias-helpdesk-staging/container-images/cubestore:v0.36.0-gorgias -f rust/cubestore/gorgias.Dockerfile rust/cubestore

docker tag us-east1-docker.pkg.dev/gorgias-helpdesk-staging/container-images/cubestore:v0.36.0-gorgias \
  us-central1-docker.pkg.dev/gorgias-revenue-staging/container-images/cubestore:v0.36.0-gorgias
docker tag us-east1-docker.pkg.dev/gorgias-helpdesk-staging/container-images/cubestore:v0.36.0-gorgias \
  us-east1-docker.pkg.dev/gorgias-helpdesk-production/container-images/cubestore:v0.36.0-gorgias
docker tag us-east1-docker.pkg.dev/gorgias-helpdesk-staging/container-images/cubestore:v0.36.0-gorgias \
  us-central1-docker.pkg.dev/gorgias-revenue-production/container-images/cubestore:v0.36.0-gorgias
```
...
docker push us-east1-docker.pkg.dev/gorgias-helpdesk-staging/container-images/cubestore:v0.36.0-gorgias
docker push us-central1-docker.pkg.dev/gorgias-revenue-staging/container-images/cubestore:v0.36.0-gorgias
docker push us-east1-docker.pkg.dev/gorgias-helpdesk-production/container-images/cubestore:v0.36.0-gorgias
docker push us-central1-docker.pkg.dev/gorgias-revenue-production/container-images/cubestore:v0.36.0-gorgias
